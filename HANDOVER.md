...
- exact next stage — **Part 006 Pass 2B Batch 9 / scans 644–654 / printed 627–637 — 11 scans**.

## Exact next activity — குறளோவியம்

Proceed with **Part 006 Pass 2B Batch 9 — scans 644–654 / printed 627–637 — 11 scans**. Batches 1–8 are **COMPLETE 88/111**. Preserve incoming **643→644 GENUINE CONTINUATION**. Perform the same independent lexical-fidelity re-read from freshly rendered source pixels; keep all records `needs-review` / visual `needs-review`; do not import web/canonical Kural wording or external commentary.
