...
**Exact downstream activity: maintained English Glossary Reconciliation GR4 — scans 112–148.** GR1–GR3 scans **1–111 are COMPLETE / PASS**; maintained-English state remains **0 draft + 496 source-checked + 1 source-limited (scan 8)**.
...
1. fetch live `main`;
2. read `works/sangatamil/translations/en/TRANSLATION_GUIDE.md`, `GLOSSARY.md`, `TRANSLATION_STATUS.md`, `SOURCE_CHECK_SC1_REPORT.md` through `SOURCE_CHECK_SC14_REPORT.md`, `GLOSSARY_RECONCILIATION_GR1_REPORT.md`, `GLOSSARY_RECONCILIATION_GR2_REPORT.md`, and `GLOSSARY_RECONCILIATION_GR3_REPORT.md`;
3. confirm first-pass drafting and source-check are **COMPLETE / CLOSED 497/497**, and GR1–GR3 scans **1–111 are COMPLETE / PASS**;
4. confirm GR3 exact compare is **1 commit / `GLOSSARY.md` only / 0 English page changes / 0 canonical Tamil changes / 0 status changes**;
5. process **English Glossary Reconciliation GR4 — scans 112–148** using `GLOSSARY.md` as a context-aware control; reconcile only recurring names, Sangam work titles, literary terms, provenance labels and repeated English renderings evidenced in Sangatamil;
...
8. preserve English page statuses during GR4, change 0 canonical Tamil files, then create the GR4 closure report, synchronize maintained-English controls, and audit the exact changed-file set;
