...
**Exact downstream activity: maintained English Editorial Review ER3 — scans 75–111.** ER1 scans **1–37** and ER2 scans **38–74 are COMPLETE / PASS**; maintained-English state is **0 draft + 423 source-checked + 73 editorial-reviewed + 1 source-limited (scan 8)**.
...
1. fetch live `main`;
2. read `works/sangatamil/translations/en/TRANSLATION_GUIDE.md`, `GLOSSARY.md`, `TRANSLATION_STATUS.md`, `SOURCE_CHECK_SC1_REPORT.md` through `SOURCE_CHECK_SC14_REPORT.md`, `GLOSSARY_RECONCILIATION_GR1_REPORT.md` through `GLOSSARY_RECONCILIATION_GR14_REPORT.md`, `EDITORIAL_REVIEW_ER1_REPORT.md`, and `EDITORIAL_REVIEW_ER2_REPORT.md`;
3. confirm first-pass drafting, source-check and glossary reconciliation are **COMPLETE / CLOSED 497/497**, ER1 scans **1–37 are COMPLETE / PASS**, and ER2 scans **38–74 are COMPLETE / PASS**;
4. confirm ER2 exact page-layer compare is **1 commit / exactly 37 modified English page files / 0 canonical Tamil changes / 37 status promotions**, with **3 source-faithful wording refinements** and **2 stale workflow-note cleanups**;
5. process **English Editorial Review ER3 — scans 75–111**; improve readability and consistency only where source meaning remains intact, and consult canonical Tamil whenever an edit could alter meaning;
...
7. promote passing `source-checked` pages in ER3 to `editorial-reviewed`; scan 8 remains permanently `source-limited`;
8. change 0 canonical Tamil files, create the ER3 closure report, synchronize maintained-English controls, and audit the exact changed-file set;
