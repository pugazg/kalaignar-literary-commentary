...
**Exact downstream activity: maintained English Source-Check SC5 — scans 149–185.** SC1–SC4 are **COMPLETE / PASS**; maintained-English state is **349 draft + 147 source-checked + 1 source-limited (scan 8)**.
...
1. fetch live `main`;
2. read `works/sangatamil/translations/en/TRANSLATION_GUIDE.md`, `GLOSSARY.md`, `TRANSLATION_STATUS.md`, `SOURCE_CHECK_SC1_REPORT.md`, `SOURCE_CHECK_SC2_REPORT.md`, `SOURCE_CHECK_SC3_REPORT.md`, and `SOURCE_CHECK_SC4_REPORT.md`;
3. confirm first-pass drafting is **COMPLETE / CLOSED 497/497** and SC1–SC4 scans **1–148 are COMPLETE / PASS**;
4. confirm SC4 exact page-layer compare is **13 commits / exactly 37 English page files / 0 canonical Tamil page changes / 0 non-English-page changes**;
5. process **English Source-Check SC5 — scans 149–185** against the maintained canonical Tamil record paragraph-by-paragraph / block-by-block;
...
8. create the SC5 closure report, synchronize maintained-English controls, and audit the exact changed-file set;
