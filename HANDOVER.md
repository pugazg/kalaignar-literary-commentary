...
**Exact downstream activity: maintained English Glossary Reconciliation GR10 — scans 334–370.** GR1–GR9 scans **1–333 are COMPLETE / PASS**; maintained-English state remains **0 draft + 496 source-checked + 1 source-limited (scan 8)**.
...
1. fetch live `main`;
2. read `works/sangatamil/translations/en/TRANSLATION_GUIDE.md`, `GLOSSARY.md`, `TRANSLATION_STATUS.md`, `SOURCE_CHECK_SC1_REPORT.md` through `SOURCE_CHECK_SC14_REPORT.md`, `GLOSSARY_RECONCILIATION_GR1_REPORT.md`, `GLOSSARY_RECONCILIATION_GR2_REPORT.md`, `GLOSSARY_RECONCILIATION_GR3_REPORT.md`, `GLOSSARY_RECONCILIATION_GR4_REPORT.md`, `GLOSSARY_RECONCILIATION_GR5_REPORT.md`, `GLOSSARY_RECONCILIATION_GR6_REPORT.md`, `GLOSSARY_RECONCILIATION_GR7_REPORT.md`, `GLOSSARY_RECONCILIATION_GR8_REPORT.md`, and `GLOSSARY_RECONCILIATION_GR9_REPORT.md`;
3. confirm first-pass drafting and source-check are **COMPLETE / CLOSED 497/497**, and GR1–GR9 scans **1–333 are COMPLETE / PASS**;
4. confirm GR9 exact compare is **3 commits / 10 English page files + `GLOSSARY.md` / 0 canonical Tamil changes / 0 status changes**;
5. process **English Glossary Reconciliation GR10 — scans 334–370** using `GLOSSARY.md` as a context-aware control; reconcile only recurring names, Sangam work titles, literary terms, provenance labels and repeated English renderings evidenced in Sangatamil;
...
8. preserve English page statuses during GR10, change 0 canonical Tamil files, then create the GR10 closure report, synchronize maintained-English controls, and audit the exact changed-file set;
