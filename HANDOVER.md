...
**Exact downstream activity: maintained English Editorial Review ER11 — scans 371–407.** ER1 scans **1–37**, ER2 scans **38–74**, ER3 scans **75–111**, ER4 scans **112–148**, ER5 scans **149–185**, ER6 scans **186–222**, ER7 scans **223–259**, ER8 scans **260–296**, ER9 scans **297–333**, and ER10 scans **334–370 are COMPLETE / PASS**; maintained-English state is **0 draft + 127 source-checked + 369 editorial-reviewed + 1 source-limited (scan 8)**.
...
1. fetch live `main`;
2. read `works/sangatamil/translations/en/TRANSLATION_GUIDE.md`, `GLOSSARY.md`, `TRANSLATION_STATUS.md`, `SOURCE_CHECK_SC1_REPORT.md` through `SOURCE_CHECK_SC14_REPORT.md`, `GLOSSARY_RECONCILIATION_GR1_REPORT.md` through `GLOSSARY_RECONCILIATION_GR14_REPORT.md`, `EDITORIAL_REVIEW_ER1_REPORT.md`, `EDITORIAL_REVIEW_ER2_REPORT.md`, `EDITORIAL_REVIEW_ER3_REPORT.md`, `EDITORIAL_REVIEW_ER4_REPORT.md`, `EDITORIAL_REVIEW_ER5_REPORT.md`, `EDITORIAL_REVIEW_ER6_REPORT.md`, `EDITORIAL_REVIEW_ER7_REPORT.md`, `EDITORIAL_REVIEW_ER8_REPORT.md`, `EDITORIAL_REVIEW_ER9_REPORT.md`, and `EDITORIAL_REVIEW_ER10_REPORT.md`;
3. confirm first-pass drafting, source-check and glossary reconciliation are **COMPLETE / CLOSED 497/497**, ER1 scans **1–37**, ER2 scans **38–74**, ER3 scans **75–111**, ER4 scans **112–148**, ER5 scans **149–185**, ER6 scans **186–222**, ER7 scans **223–259**, ER8 scans **260–296**, ER9 scans **297–333**, and ER10 scans **334–370 are COMPLETE / PASS**;
4. confirm ER10 exact page-layer compare is **1 commit / exactly 37 modified English page files / 0 canonical Tamil changes / 37 status promotions**, with **10 source-faithful editorial refinements**;
5. process **English Editorial Review ER11 — scans 371–407**; improve readability and consistency only where source meaning remains intact, and consult canonical Tamil whenever an edit could alter meaning;
...
7. promote passing `source-checked` pages in ER11 to `editorial-reviewed`; scan 8 remains permanently `source-limited`;
8. change 0 canonical Tamil files, create the ER11 closure report, synchronize maintained-English controls, and audit the exact changed-file set;
