...
- exact next stage — **Part 006 Pass 2B Batch 8 / scans 633–643 / printed 616–626 — 11 scans**.

## Exact next activity — குறளோவியம்

Proceed with **Part 006 Pass 2B Batch 8 — scans 633–643 / printed 616–626 — 11 scans**. Batches 1–7 are **COMPLETE 77/111**. Preserve incoming **632→633 CLEAN**. Perform the same independent lexical-fidelity re-read from freshly rendered source pixels; keep all records `needs-review` / visual `needs-review`; do not import web/canonical Kural wording or external commentary.
