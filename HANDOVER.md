...
- exact next stage — **Part 006 Pass 3 Batch 5 / scans 600–610 / printed 583–593 — 11 scans**.

## Exact next activity — குறளோவியம்

Proceed with **Part 006 Pass 3 Batch 5 — scans 600–610 / printed 583–593 — 11 scans**. Batches 1–4 are **COMPLETE 44/111**. Preserve incoming **599→600 GENUINE CONTINUATION**; inspect scan 611 only as the outgoing witness if required. Keep all records `needs-review` / visual `needs-review`.
