...
**Exact downstream activity: maintained English Source-Check SC4 — scans 112–148.** SC1–SC3 are **COMPLETE / PASS**; maintained-English state is **386 draft + 110 source-checked + 1 source-limited (scan 8)**.
...
1. fetch live `main`;
2. read `works/sangatamil/translations/en/TRANSLATION_GUIDE.md`, `GLOSSARY.md`, `TRANSLATION_STATUS.md`, `SOURCE_CHECK_SC1_REPORT.md`, `SOURCE_CHECK_SC2_REPORT.md`, and `SOURCE_CHECK_SC3_REPORT.md`;
3. confirm first-pass drafting is **COMPLETE / CLOSED 497/497** and SC1–SC3 scans **1–111 are COMPLETE / PASS**;
4. confirm SC3 exact page-layer compare is **13 commits / exactly 37 English page files / 0 canonical Tamil page changes / 0 non-English-page changes**;
5. process **English Source-Check SC4 — scans 112–148** against the maintained canonical Tamil record paragraph-by-paragraph / block-by-block;
...
8. create the SC4 closure report, synchronize maintained-English controls, and audit the exact changed-file set;
