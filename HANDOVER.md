...
Parts **001–005** are audited / archival-ready through overall scan **106** / printed page **73** / Kural **365**.
...
The latest English review/release authority remains:
...
`திருக்குறள்_கலைஞர்_உரை_part_006_pages_107-127.pdf`
...
Part 006 completes the Book of Aram material at Kural 380 and then contains:

- scan 110 — `பொருள்` section-title page;
- scan 111 — blank reverse;
- scan 112 — first `பொருள்` main-body page, header `பொருள் - அரசியல் - இறைமாட்சி`.

The visible printed pagination jumps from **76** to **79** across the title/blank leaves. Do not invent printed page numbers for scans 110–111.
