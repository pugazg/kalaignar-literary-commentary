...
- Tamil changes: **0**;
- **366→367 genuine continuation** and **399→400 CLEAN** preserved;
- scan **444 / printed 427 remains source-open**;
- external **444→445 DEFERRED / UNRESOLVED**.

### Exact next content stage

Process **Part 004 English editorial review ER3 — scans 400–432 / printed 383–415, 33 pages**. Follow the maintained editorial-review rules: source-faithful readability/consistency review only, promote only passing pages to `editorial-reviewed`, do not alter Tamil records, and do not begin Part 005.
