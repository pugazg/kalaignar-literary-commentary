...
**SOURCE INTAKE: PASS / COMPLETE. PASS 1: COMPLETE 111/111. PASS 2A: ACTIVE 55/111.**
...
Continue **Part 005 Pass 2A Batch 6 — scans 500–510 / printed 483–493**. Preserve the incoming **499→500 GENUINE CONTINUATION** and inspect scan **511 / printed 494** only as the outgoing witness when required. Do not promote final textual/visual status during Pass 2A; Pass 2B and Pass 3 still remain mandatory. Do not begin Part 006 transcription yet.
