...
Part 005 is **FULLY CLOSED** at `works/kuraloviyam/PART_005_FINAL_CLOSURE.md`; do not reopen it. Part 006 Pass 1 is now **55/111 captured**: P6-01 / scans **556–566**, P6-02 / scans **567–577**, P6-03 / scans **578–588**, P6-04 / scans **589–599**, and P6-05 / scans **600–610** are all **COMPLETE 11/11**. P6-05 endpoint is `4a354302c2e3bd3be5a997e65632ab61674edc82`; exact compare from `2d8353d246467bedabcc9dfc6e0e0287e61bdc66` changes exactly **11 newly added Part 006 Tamil page files** and **0 non-page files**. All 55 records remain `needs-review` / visual `needs-review`. Incoming **599→600 GENUINE CONTINUATION** is preserved; outgoing **610→611 GENUINE CONTINUATION** is directly source-checked. The active frontier is now **P6-06 — scans 611–621 / printed 594–604 — 11 scans**. Use rendered Part 006 source pixels as controlling authority, preserve physical-page boundaries/page functions/visuals, and do not import web/canonical Kural wording or external commentary.
