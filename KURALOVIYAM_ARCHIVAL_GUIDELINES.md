...
- textual `partial` / explicit source-limited — **4**: scans **13, 14, 15, 19**;
...
- `release-ready` — **662**;
- `source-limited` — **4** matching Part 001 scans **13, 14, 15, 19**;
- blocked — **0**.

Part 006 specifically is **Tamil ARCHIVAL-READY / CLOSED 111/111** and **English RELEASE COMPLETE / CLOSED 111/111 release-ready**.

The page-batched archival/translation workflow now has **no active frontier**. Closed source material should be reopened only for a genuinely new provenance/fidelity issue. New derivatives or publication outputs must preserve the closed archival and release decisions unless new source evidence explicitly requires revision.


## Current derived-navigation state

The archival and maintained-English page workflows are fully closed. Downstream navigation work is also complete through **S3**:

- all physical scans **1–666** remain accounted for by the closed archival page layer;
- scans **1–33** — front matter / transition material;
- scans **34–657** — source contents entries **1–300**;
- scans **658–665** — complete source contents/index backmatter;
- scan **666** — unnumbered pictorial back cover / physical endpoint;
- S2 — **300/300 entry-to-Adhikaram crosswalk complete**;
- S3 — **300/300 individual entry leaves + JSON/TSV/web-ready indexes complete**;
- closed Tamil/English page records changed by S2/S3 — **0**.

Current derived controls: `works/kuraloviyam/sections/SECTIONS_BUILD_STATUS.md` and `works/kuraloviyam/sections/S3_COMPLETION_REPORT.md`.
