...
Part 005 is **FULLY CLOSED** at `works/kuraloviyam/PART_005_FINAL_CLOSURE.md`; do not reopen it. Part 006 Pass 1 is now **66/111 captured**: P6-01 / scans **556–566**, P6-02 / scans **567–577**, P6-03 / scans **578–588**, P6-04 / scans **589–599**, P6-05 / scans **600–610**, and P6-06 / scans **611–621** are all **COMPLETE 11/11**. P6-06 page-layer commits are `81471a82f45e35958c966aef6243fd6983c619a6` and endpoint `b05d0389346f42db21e7b2e1a93b7a088b535682`; exact compare from `5566759d2578df9376839df237a08eafe6d04bb5` changes exactly **11 newly added Part 006 Tamil page files** and **0 non-page files**. All 66 records remain `needs-review` / visual `needs-review`. Incoming **610→611 GENUINE CONTINUATION** is preserved; outgoing **621→622 GENUINE CONTINUATION** is directly source-checked. The active frontier is now **P6-07 — scans 622–632 / printed 605–615 — 11 scans**. Use rendered Part 006 source pixels as controlling authority, preserve physical-page boundaries/page functions/visuals, and do not import web/canonical Kural wording or external commentary.
