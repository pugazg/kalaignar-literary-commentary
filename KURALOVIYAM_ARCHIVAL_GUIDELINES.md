...
Part 005 is **FULLY CLOSED** at `works/kuraloviyam/PART_005_FINAL_CLOSURE.md`; do not reopen it. Part 006 Pass 1 is now **22/111 captured**: P6-01 / scans **556–566** and P6-02 / scans **567–577** are both **COMPLETE 11/11**. P6-02 endpoint is `3d7b742c14fc8075d61eed3d47d5b6e4e2a0ef2d`; exact compare from `c11f4cd3964f083eba76e5ed14b1803d869463ff` changes exactly **11 newly added Part 006 Tamil page files** and **0 non-page files**. All 22 records remain `needs-review` / visual `needs-review`. Incoming **566→567 GENUINE CONTINUATION** is preserved; outgoing **577→578 GENUINE CONTINUATION** is directly source-checked. The active frontier is now **P6-03 — scans 578–588 / printed 561–571 — 11 scans**. Use rendered Part 006 source pixels as controlling authority, preserve physical-page boundaries/page functions/visuals, and do not import web/canonical Kural wording or external commentary.
