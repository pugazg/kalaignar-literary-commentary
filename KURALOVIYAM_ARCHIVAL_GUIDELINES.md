...
- cumulative Tamil Pass-1 capture — **44/111**;
- current captured records — **44 `needs-review` / visual `needs-review`**;
- **488→489 CLEAN**;
...
Continue **Part 005 P5-05 — scans 489–499 / printed 472–482**. Rendered source pixels remain controlling. Do not begin Part 006 transcription yet.
