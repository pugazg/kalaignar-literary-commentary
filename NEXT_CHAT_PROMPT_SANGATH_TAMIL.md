# NEXT CHAT PROMPT — சங்கத் தமிழ் / Gate C2 C17 / scans 401–425
...
- scans **401–497 remain Gemini-lexical-locked**
- Gate G — **DEFERRED**
...
**Wait for the user's findings/instructions for scans 401–425.**

Do not modify scans 401+ merely from the historical Gate-C ledger. When the user supplies C2 adjudications, treat those findings as controlling evidence for that batch, apply only authorized changes, and keep all later scans locked.
