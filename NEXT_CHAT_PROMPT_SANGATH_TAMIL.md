# NEXT CHAT PROMPT — சங்கத் தமிழ் / MAINTAINED ENGLISH GLOSSARY RECONCILIATION GR8
...
- glossary reconciliation — **259/497 reviewed**
...
**Glossary Reconciliation GR8 — scans 260–296.**

Requirements:

- begin at scan **260** and reconcile terminology through scan **296**;
...
- after scans **260–296** are reconciled, create the GR8 closure report and synchronize maintained-English controls;
- audit the exact changed-file set;
- change **0 canonical Tamil page files**.

GR1–GR7 are closed. Do not import terminology from published translations, web sources or remembered conventional renderings during GR8.
