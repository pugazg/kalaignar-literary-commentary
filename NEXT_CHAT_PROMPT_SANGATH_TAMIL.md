# NEXT CHAT PROMPT — சங்கத் தமிழ் / MAINTAINED ENGLISH GLOSSARY RECONCILIATION GR9
...
- glossary reconciliation — **296/497 reviewed**
...
**Glossary Reconciliation GR9 — scans 297–333.**

Requirements:

- begin at scan **297** and reconcile terminology through scan **333**;
...
- after scans **297–333** are reconciled, create the GR9 closure report and synchronize maintained-English controls;
- audit the exact changed-file set;
- change **0 canonical Tamil page files**.

GR1–GR8 are closed. Do not import terminology from published translations, web sources or remembered conventional renderings during GR9.
