# Controlled English Glossary — Kuraloviyam

This glossary records editorial defaults for the **project-created English translation** of `குறளோவியம்`.

Defaults are context-aware. If a later passage requires a different rendering to preserve meaning, record that decision during review rather than forcing one English equivalent mechanically.

## Work and structural terms

| Tamil | Default English | Editorial note |
|---|---|---|
| குறளோவியம் | Kuraloviyam | Retain the work title in transliteration. |
| திருக்குறள் | Thirukkural | Established project title. |
| குறள் | Kural | Use `Kural` for an individual verse; preserve source number when present. |
| வள்ளுவர் / திருவள்ளுவர் | Valluvar / Thiruvalluvar | Follow the form used by the Tamil sentence where meaningful; `Thiruvalluvar` for full-name reference. |
...
| முப்பால் | Muppaal / the three divisions | Retain `Muppaal` when the source names the classical threefold structure as a term; plain prose may use `the three divisions`. |
...
|---|---|---|
| பாரதி பதிப்பகம் | Bharathi Pathippagam | Preserve the source's own printed English form where available. |
| தமிழ்க்கனிப் பதிப்பகம் | Tamilkani Pathippagam | Preserve the source's own printed English form where available. |
...
| பரிதியார் | Parithiyar | Transliterate. |
| காலிங்கர் | Kalingar | Transliterate. |
| பரிப்பெருமாள் | Paripperumal | Transliterate. |
| முரசொலி மாறன் | Murasoli Maran | Retain established personal-name form used in the Preface. |
| சாவி | Saavi | Retain writer/editor's name in transliteration. |
| கிருட்டிணன் | Kiruttinan | Retain the transliteration used in scan 5. |
...
| முத்துவேலர் | Muthuvelar | Retain Kalaignar's father's name in transliteration. |
| அஞ்சுக அன்னை | Mother Anjugam | Preserve the maternal honorific in context. |
