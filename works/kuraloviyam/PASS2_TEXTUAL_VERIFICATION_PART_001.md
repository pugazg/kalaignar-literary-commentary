# குறளோவியம் — Part 001 Pass 2 textual verification
...
- headings and printed-page metadata;
...
|---:|---|---|
| 1 | — | corrected author-line spacing to source-visible `கலைஞர் மு.கருணாநிதி` |
| 2 | — | corrected author-line spacing to source-visible `கலைஞர் மு.கருணாநிதி` |
| 3 | — | textual comparison complete; no page-record correction required; handwritten `12800` remains separate from printed imprint text |
| 4 | iii | textual comparison complete; no page-record correction required; library stamp remains separate from printed prose |
| 5 | iv | corrected source-visible spacing `வாரந்தோறும்` → `வாரந் தோறும்` in the final `தினமணி கதிர்` sentence |
| 6 | v | textual comparison complete; no page-record correction required |
| 7 | vi | textual comparison complete; no page-record correction required |
