# குறளோவியம் — Part 001 Pass 2B lexical-fidelity re-read

Controlling source: `TVA_BOK_0065733_குறளோவியம்_part_001_pages_1-111.pdf`

This log records the independent **Pass 2B lexical-fidelity re-read** only. Pass 2A is already complete for scans 1–111. Pass 2B does **not** claim Pass 3 visual-text verification, the Part 001 audit, archival-ready status, or final `verified` page status.

Pass 2B independently re-reads every source-visible printed word against the rendered scan, with special attention to `ர/ற`, `ன/ண`, `ல/ள/ழ`, vowel signs, compound letters, source-visible joining/spacing, old or uncommon forms, names, quotations and Kural text. The rendered scan remains controlling; no normalization or standard-edition substitution is permitted.
...
|---:|---|---|
| 1 | — | independent lexical re-read complete; cover title and author line match the source; no correction required |
