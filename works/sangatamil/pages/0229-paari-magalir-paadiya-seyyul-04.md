...
<!-- Gate B restores File5 wording and source order: closing narrative → separator → Purananuru verse → separator → provenance → `பொருள் விளக்கம்`. -->
