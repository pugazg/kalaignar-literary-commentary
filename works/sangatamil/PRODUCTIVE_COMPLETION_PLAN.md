...
- Gate F — **IN PROGRESS — F01 scans 1–25 COMPLETE / PASS; 2 formal provenance units; provenance frontier scan 26**
...
Exact next activity: **Gate F — Sangam provenance audit / continue from scan 26**.
...
F01 durable outputs are now live:
- `works/sangatamil/indexes/source-citation-register.md` — F01 verified entries recorded;
- `works/sangatamil/PROVENANCE_AUDIT.md` — F01 COMPLETE / PASS.

Continue Gate F from **scan 26**.
