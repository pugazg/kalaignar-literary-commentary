...
If a printed attribution conflicts with an external critical edition, preserve the printed form here and create a separate comparison note; do not rewrite this register silently.
