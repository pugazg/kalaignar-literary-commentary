...
The actual supplied PDF has been independently confirmed as **497 scans**. Scans 493–497 render successfully from the same mounted PDF and scan 497 is the back cover.
...
- printed-page numbering must be read from the source and never inferred from scan arithmetic.
...
| Scan(s) | Printed page(s) | Source role | Current state |
|---:|---|---|---|
| 1 | — | illustrated cover | `verified` |
...
| 491–496 | printed 479–484 with scan-493 illustration | `ஒருதலைக் காதல் — 11` | **R50 complete / all six verified; C20-003..006 preserved** |
| 497 | unnumbered | back cover / end matter | **R50 complete / verified / physical endpoint** |

## Important controls

- The first visible Arabic printed body number is **2** on scan 17; printed page 1 is not inferred.
...
- `மலர்மாரி பொழிகின்றேன்!`: **scans 17–19 — COMPLETE / VERIFIED under earlier workflow**;
- `யாதும் ஊரே; யாவரும் கேளிர்!`: **scans 20–24 — COMPLETE / VERIFIED under earlier workflow**;
- `மானங்காத்த மறவன்!`: **scans 25–30 — COMPLETE / VERIFIED under earlier workflow**;
- `துணை நின்றாள் தோழி!`: **scans 31–36 — REOPENED after demonstrated regression; corrected lexical scaffold now `needs-review` on text pages**;
- `சுமந்தவன் சுமந்த சோகம்!`: **scans 37–41 — COMPLETE / VERIFIED under earlier workflow**;
- `பாவை புகழ்ந்த பன்றி`: **scans 42–46 — COMPLETE / VERIFIED under earlier workflow**;
- `காக்கைக்கு நன்றி காட்ட...`: **scans 47–49 — COMPLETE / VERIFIED under earlier workflow**.
