...
**English Editorial Review ER4 — scans 112–148.** ER1 scans **1–37**, ER2 scans **38–74**, and ER3 scans **75–111 are COMPLETE / PASS**. Continue source-faithful editorial review; promote passing `source-checked` pages to `editorial-reviewed`, preserve scan 8 as `source-limited`, and change **0 canonical Tamil page files**.
