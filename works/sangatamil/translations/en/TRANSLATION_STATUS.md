...
**Status: ACTIVE — GLOSSARY RECONCILIATION GR1–GR3 COMPLETE / PASS**
...
**English Glossary Reconciliation GR4 — scans 112–148.**
...
Continue the same context-aware terminology reconciliation for scans **112–148**. Preserve page statuses; scan 8 remains `source-limited`. Change **0 canonical Tamil page files** and do not import terminology from published translations or web sources.
