...
- glossary reconciliation — **333/497 — GR1+GR2+GR3+GR4+GR5+GR6+GR7+GR8+GR9 COMPLETE / PASS**
...
Exact next activity: **English Glossary Reconciliation GR10 — scans 334–370**. Use `GLOSSARY.md` as a context-aware control; reconcile only recurring terminology evidenced in Sangatamil, preserve English page statuses, keep scan 8 `source-limited`, and change **0 canonical Tamil page files**.
