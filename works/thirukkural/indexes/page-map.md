...
| Part | Overall scans | Printed-page span | Content span | Tamil record state | Audit |
|---|---:|---|---|---|---|
| 001 | 1–20 | front matter through xix | cover / publication matter / prefaces / reviews | 19 verified + scan 8 documented partial | `AUDIT_PART_001.md` |
| 002 | 21–41 | xx–xxxi/title/blank, then 1–8 | front matter completion; Kural 1–40 | 21/21 verified | `AUDIT_PART_002.md` |
| 003 | 42–62 | 9–29 | Kural 41–145 | 21/21 verified | `AUDIT_PART_003.md` |
| 004 | 63–84 | 30–51 | Kural 146–255 | 22/22 verified | `AUDIT_PART_004.md` |
| 005 | 85–106 | 52–73 | Kural 256–365 | 22/22 verified | `AUDIT_PART_005.md` |
| 006 | 107–127 | 74–94 with unnumbered title/blank leaves | Kural 366–460; `அறம்` → `பொருள்` transition | 21/21 verified | `AUDIT_PART_006.md` |
| 007 | 128–148 | 95–115 | Kural 461–565 | 21/21 verified | `AUDIT_PART_007.md` |
| 008 | 149–169 | 116–136 | Kural 566–670 | 21/21 verified | `AUDIT_PART_008.md` |
| 009 | 170–191 | 137–158 | Kural 671–780 | 22/22 verified | `AUDIT_PART_009.md` |
| 010 | 192–214 | 159–181 | Kural 781–895 | 23/23 verified | `AUDIT_PART_010.md` |
| 011 | 215–237 | 182–204 | Kural 896–1010 | 23/23 verified | `AUDIT_PART_011.md` |
...
- scan 3 is blank;
- scan 8 is a handwritten facsimile and remains documented `partial` where the continuous handwriting is not safely legible.

### Part 002

- scan 33 is blank/reverse-side bleed-through;
- scans 27 and 32 use source-supported inferred front-matter pagination documented in the Part 002 audit.

### Part 006

- scan 110 is the unnumbered `பொருள்` title leaf;
- scan 111 is its blank reverse;
- visible printed pagination therefore moves from 76 to 79 without inventing 77–78.

### Part 012

- scans 252–253 are the `இன்பம்` title leaf and blank/reverse-show-through leaf;
- main-body pagination resumes at printed page 221.
